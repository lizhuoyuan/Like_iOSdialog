package li.zhuoyuan.like_iosdialog;
...
import li.zhuoyuan.ios_dialog.widget.ActionSheetDialog;
import li.zhuoyuan.ios_dialog.widget.MyAlertDialog;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
                        ...
                        .addSheetItem("清空消息列表", ActionSheetDialog.SheetItemColor.Red,
                                new ActionSheetDialog.OnSheetItemClickListener() {
                                    ...
                                    public void onClick(int which) {
                                        Toast.makeText(MainActivity.this, "嗯,空了", Toast.LENGTH_SHORT).show();
                                    }
                                }).show();
                break;
            case R.id.btn2:
            ...
            case R.id.btn3:
                ...
                break;
            case R.id.btn4:
                new MyAlertDialog(MainActivity.this).builder().setTitle("退出当前账号")
